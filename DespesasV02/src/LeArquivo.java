...
public class LeArquivo {
	...
	//Construtor
	public LeArquivo(HashMap<LocalDate, SaldoDiario> mapa, String filePath) {
		this.mapa = mapa;
	...
	public HashMap<LocalDate, SaldoDiario> PreencheMapa(Saldo saldo) throws FileNotFoundException{
